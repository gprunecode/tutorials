...
% \begin{figure}[h!]
%   \centering
%   \includegraphics[scale=0.75]{./Pictures/156_wb_exportar_bd.png}
% \end{figure}
%
% \begin{figure}[h!]
%   \centering
%   \includegraphics[scale=0.75]{./Pictures/157_wb_exportar_bd.png}
% \end{figure}
%
% \begin{figure}[h!]
%   \centering
%   \includegraphics[scale=0.75]{./Pictures/158_wb_expoertar_bd.png}
% \end{figure}
